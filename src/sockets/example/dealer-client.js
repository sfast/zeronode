...
import { Dealer as DealerSocket, Enum } from '../index.js'
...
async function runDealer() {
  ...
  // To test infinite reconnection, set it to Enum.Timeouts.INFINITY
  const RECONNECTION_TIMEOUT = 20000  // Give up after 20 seconds (for testing)
  // const RECONNECTION_TIMEOUT = Enum.Timeouts.INFINITY  // Never give up (production)
